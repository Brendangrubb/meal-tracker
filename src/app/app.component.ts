...
export class AppComponent {
  ...
  foodList: Food[] = [
    ...
    new Food('Vegan BLT', 'lunch', 'extra bacon, add cheese, hold the lettuce and tomato..delicious and totally worth it!', 550),
    new Food('Fries', 'snack', 'french fries with mustard and vinegar', 600),
    new Food('Sausage Stuffed Tomatoes', 'dinner', 'steak tomatoes stuffed with a vegan sausage hash with rice and asparagus', 650)
  ];
